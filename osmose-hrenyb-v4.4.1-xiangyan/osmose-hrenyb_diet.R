...
osmose.configuration.calibration = input/calibration-parameters_cbined.csv
# Setting the model -------------------------------------------------------
...
species.file.sp17 = ../forcing/resources/HRENYBLTL2000-2019_updated.nc
species.file.sp18 = ../forcing/resources/HRENYBLTL2000-2019_updated.nc
species.file.sp19 = ../forcing/resources/HRENYBLTL2000-2019_updated.nc
species.file.sp20 = ../forcing/resources/HRENYBLTL2000-2019_updated.nc
species.file.sp21 = ../forcing/resources/HRENYBLTL2000-2019_updated.nc
species.file.sp22 = ../forcing/resources/HRENYBLTL2000-2019_updated.nc
species.file.sp23 = ../forcing/resources/HRENYBLTL2000-2019_updated.nc
...
# Resources sizes 
species.size.max.sp17 = 0.0002
species.size.min.sp17 = 0.00002
...
species.size.min.sp20 = 0.0002
species.size.max.sp21 = 0.2
species.size.min.sp21 = 0.02
species.size.max.sp22 = 0.0002
species.size.min.sp22 = 0.00002
...
predation.accessibility.file = input/osm_predation-accessibility_effdepth_lifestage_update.csv
...
output.diet.stage.threshold.sp0        = 5,16.7
output.diet.stage.threshold.sp1        = 5,28.7
output.diet.stage.threshold.sp2        = 5,19.1
output.diet.stage.threshold.sp3        = 5,15.5
output.diet.stage.threshold.sp4        = 80.9
output.diet.stage.threshold.sp5        = 5,50
output.diet.stage.threshold.sp6        = 5,46.5
output.diet.stage.threshold.sp7        = 5,26.8
output.diet.stage.threshold.sp8        = 5,15
output.diet.stage.threshold.sp9        = 5,35
output.diet.stage.threshold.sp10       = 37.5
output.diet.stage.threshold.sp11       = 5,23.2
output.diet.stage.threshold.sp12       = 2,4
output.diet.stage.threshold.sp13       = 5,17.5
output.diet.stage.threshold.sp14       = 5,22.1
output.diet.stage.threshold.sp15       = 5,14.25
output.diet.stage.threshold.sp16       = 5,15
